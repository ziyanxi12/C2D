...
public:
  ...
  bool skipProgressBlurStopField(kiwi::ByteBuffer &bb, uint32_t id) const;
  ...
  bool skipDynamicStrokeSettingsField(kiwi::ByteBuffer &bb, uint32_t id) const;
  ...
  bool skipProdExtraCombinationChartInfoField(kiwi::ByteBuffer &bb, uint32_t id) const;
  bool skipProdOneDimChartField(kiwi::ByteBuffer &bb, uint32_t id) const;
...
private:
  ...
  uint32_t _indexProgressBlurStop = 0;
  ...
  uint32_t _indexDynamicStrokeSettings = 0;
  ...
  uint32_t _indexProdExtraCombinationChartInfo = 0;
  uint32_t _indexProdOneDimChart = 0;
...
class ProdExtraCombinationChartInfo;
class ProdOneDimChart;
...
public:
  ...
  kiwi::Array<ProgressBlurStop> *progressiveStops();
  const kiwi::Array<ProgressBlurStop> *progressiveStops() const;
  kiwi::Array<ProgressBlurStop> &set_progressiveStops(kiwi::MemoryPool &pool, uint32_t count);
...
private:
  ...
  Vector *_data_center = {};
  kiwi::Array<ProgressBlurStop> _data_progressiveStops = {};
  float _data_radius = {};
  float _data_spread = {};
...
public:
  ...
  float *delayMs();
  const float *delayMs() const;
  void set_delayMs(const float &value);
...
class DynamicStrokeSettings {
public:
  DynamicStrokeSettings() { (void)_flags; }
  ...
  float *wiggle();
  const float *wiggle() const;
  void set_wiggle(const float &value);

  float *smoothen();
  const float *smoothen() const;
  void set_smoothen(const float &value);
...
private:
  uint32_t _flags[1] = {};
  float _data_frequency = {};
  float _data_wiggle = {};
  float _data_smoothen = {};
};
...
public:
  ...
  const DynamicStrokeSettings *dynamicStrokeSettings() const;
  void set_dynamicStrokeSettings(DynamicStrokeSettings *value);

  int32_t *strokeSeed();
  const int32_t *strokeSeed() const;
  void set_strokeSeed(const int32_t &value);
...
private:
  ...
  DynamicStrokeSettings *_data_dynamicStrokeSettings = {};
  int32_t _data_count = {};
...
public:
  ...
  Paint *inactiveFillPaint();
  const Paint *inactiveFillPaint() const;
  void set_inactiveFillPaint(Paint *value);

  ProdOneDimChart *oneDimChart();
  const ProdOneDimChart *oneDimChart() const;
  void set_oneDimChart(ProdOneDimChart *value);
...
private:
  ...
  Paint *_data_inactiveFillPaint = {};
  ProdOneDimChart *_data_oneDimChart = {};
...
public:
  ...
  int32_t *styleType();
  const int32_t *styleType() const;
  void set_styleType(const int32_t &value);
...
private:
  ...
  float _data_value = {};
  int32_t _data_styleType = {};
};

class ProdExtraCombinationChartInfo {
public:
  ProdExtraCombinationChartInfo() { (void)_flags; }
  ...
  int32_t *axisType();
  const int32_t *axisType() const;
  void set_axisType(const int32_t &value);
...
private:
  ...
  int32_t _data_axisType = {};
};

class ProdOneDimChart {
public:
  ProdOneDimChart() { (void)_flags; }

  kiwi::Array<Path> *chartAreaFillGeometry();
  const kiwi::Array<Path> *chartAreaFillGeometry() const;
  kiwi::Array<Path> &set_chartAreaFillGeometry(kiwi::MemoryPool &pool, uint32_t count);
  ...
  const float *innerRadiusRatio() const;
  void set_innerRadiusRatio(const float &value);
...
private:
  uint32_t _flags[1] = {};
  kiwi::Array<Path> _data_chartAreaFillGeometry = {};
...
public:
  ...
  ProdExtraCombinationChartInfo *extraCombinationChartInfo();
  const ProdExtraCombinationChartInfo *extraCombinationChartInfo() const;
  void set_extraCombinationChartInfo(ProdExtraCombinationChartInfo *value);
...
private:
  ...
  kiwi::Array<float> _data_legendSymPos = {};
  kiwi::Array<float> _data_axisScale = {};
  ProdExtraCombinationChartInfo *_data_extraCombinationChartInfo = {};
  int32_t _data_legendDir = {};
...
public:
  ...
  const bool *isOverrideOverTextStyle() const;
  void set_isOverrideOverTextStyle(const bool &value);
...
private:
  ...
  float _data_paragraphSpacing = {};
  bool _data_detachOpticalSizeFromFontSize = {};
  bool _data_isOverrideOverTextStyle = {};
};
...
bool BinarySchema::parse(kiwi::ByteBuffer &bb) {
  ...
  _schema.findDefinition("ProgressBlurStop", _indexProgressBlurStop);
  ...
  _schema.findDefinition("DynamicStrokeSettings", _indexDynamicStrokeSettings);
  ...
  _schema.findDefinition("ProdExtraCombinationChartInfo", _indexProdExtraCombinationChartInfo);
  _schema.findDefinition("ProdOneDimChart", _indexProdOneDimChart);
...
bool BinarySchema::skipProgressBlurStopField(kiwi::ByteBuffer &bb, uint32_t id) const {
  return _schema.skipField(bb, _indexProgressBlurStop, id);
}
...
bool BinarySchema::skipDynamicStrokeSettingsField(kiwi::ByteBuffer &bb, uint32_t id) const {
  return _schema.skipField(bb, _indexDynamicStrokeSettings, id);
}
...
bool BinarySchema::skipProdExtraCombinationChartInfoField(kiwi::ByteBuffer &bb, uint32_t id) const {
  return _schema.skipField(bb, _indexProdExtraCombinationChartInfo, id);
}

bool BinarySchema::skipProdOneDimChartField(kiwi::ByteBuffer &bb, uint32_t id) const {
  return _schema.skipField(bb, _indexProdOneDimChart, id);
}
...
float *ProgressBlurStop::position() {
  return _flags[0] & 1 ? &_data_position : nullptr;
}

const float *ProgressBlurStop::position() const {
  return _flags[0] & 1 ? &_data_position : nullptr;
}

void ProgressBlurStop::set_position(const float &value) {
  _flags[0] |= 1; _data_position = value;
}

float *ProgressBlurStop::radius() {
  return _flags[0] & 2 ? &_data_radius : nullptr;
}

const float *ProgressBlurStop::radius() const {
  return _flags[0] & 2 ? &_data_radius : nullptr;
}

void ProgressBlurStop::set_radius(const float &value) {
  _flags[0] |= 2; _data_radius = value;
}

bool ProgressBlurStop::encode(kiwi::ByteBuffer &_bb) {
  if (position() != nullptr) {
    _bb.writeVarUint(1);
    _bb.writeVarFloat(_data_position);
  }
...
bool ProgressBlurStop::decode(kiwi::ByteBuffer &_bb, kiwi::MemoryPool &_pool, const BinarySchema *_schema) {
  while (true) {
    uint32_t _type;
    if (!_bb.readVarUint(_type)) return false;
    switch (_type) {
      ...
      default: {
        if (!_schema || !_schema->skipProgressBlurStopField(_bb, _type)) return false;
        break;
      }
    }
  }
...
kiwi::Array<ProgressBlurStop> *Effect::progressiveStops() {
  return _flags[1] & 64 ? &_data_progressiveStops : nullptr;
}

const kiwi::Array<ProgressBlurStop> *Effect::progressiveStops() const {
  return _flags[1] & 64 ? &_data_progressiveStops : nullptr;
}

kiwi::Array<ProgressBlurStop> &Effect::set_progressiveStops(kiwi::MemoryPool &pool, uint32_t count) {
  _flags[1] |= 64; return _data_progressiveStops = pool.array<ProgressBlurStop>(count);
}
...
bool Effect::encode(kiwi::ByteBuffer &_bb) {
  ...
  if (progressiveStops() != nullptr) {
    _bb.writeVarUint(39);
    _bb.writeVarUint(_data_progressiveStops.size());
    for (ProgressBlurStop &_it : _data_progressiveStops) if (!_it.encode(_bb)) return false;
  }
  _bb.writeVarUint(0);
  return true;
}
...
bool Effect::decode(kiwi::ByteBuffer &_bb, kiwi::MemoryPool &_pool, const BinarySchema *_schema) {
  ...
  while (true) {
    ...
    switch (_type) {
      ...
      case 39: {
        if (!_bb.readVarUint(_count)) return false;
        for (ProgressBlurStop &_it : set_progressiveStops(_pool, _count)) if (!_it.decode(_bb, _pool, _schema)) return false;
        break;
      }
      default: {
...
float *PrototypeEvent::delayMs() {
  return _flags[0] & 64 ? &_data_delayMs : nullptr;
}

const float *PrototypeEvent::delayMs() const {
  return _flags[0] & 64 ? &_data_delayMs : nullptr;
}

void PrototypeEvent::set_delayMs(const float &value) {
  _flags[0] |= 64; _data_delayMs = value;
}
...
bool PrototypeEvent::encode(kiwi::ByteBuffer &_bb) {
  ...
  if (delayMs() != nullptr) {
    _bb.writeVarUint(7);
    _bb.writeVarFloat(_data_delayMs);
  }
  _bb.writeVarUint(0);
  return true;
}
...
bool PrototypeEvent::decode(kiwi::ByteBuffer &_bb, kiwi::MemoryPool &_pool, const BinarySchema *_schema) {
  while (true) {
    ...
    switch (_type) {
      ...
      case 7: {
        if (!_bb.readVarFloat(_data_delayMs)) return false;
        set_delayMs(_data_delayMs);
        break;
      }
      default: {
...
float *DynamicStrokeSettings::frequency() {
  return _flags[0] & 1 ? &_data_frequency : nullptr;
}

const float *DynamicStrokeSettings::frequency() const {
  return _flags[0] & 1 ? &_data_frequency : nullptr;
}

void DynamicStrokeSettings::set_frequency(const float &value) {
  _flags[0] |= 1; _data_frequency = value;
}

float *DynamicStrokeSettings::wiggle() {
  return _flags[0] & 2 ? &_data_wiggle : nullptr;
}

const float *DynamicStrokeSettings::wiggle() const {
  return _flags[0] & 2 ? &_data_wiggle : nullptr;
}

void DynamicStrokeSettings::set_wiggle(const float &value) {
  _flags[0] |= 2; _data_wiggle = value;
}

float *DynamicStrokeSettings::smoothen() {
  return _flags[0] & 4 ? &_data_smoothen : nullptr;
}

const float *DynamicStrokeSettings::smoothen() const {
  return _flags[0] & 4 ? &_data_smoothen : nullptr;
}

void DynamicStrokeSettings::set_smoothen(const float &value) {
  _flags[0] |= 4; _data_smoothen = value;
}

bool DynamicStrokeSettings::encode(kiwi::ByteBuffer &_bb) {
  if (frequency() != nullptr) {
    _bb.writeVarUint(1);
    _bb.writeVarFloat(_data_frequency);
  }
  if (wiggle() != nullptr) {
    _bb.writeVarUint(2);
    _bb.writeVarFloat(_data_wiggle);
  }
  if (smoothen() != nullptr) {
    _bb.writeVarUint(3);
    _bb.writeVarFloat(_data_smoothen);
  }
  _bb.writeVarUint(0);
  return true;
}

bool DynamicStrokeSettings::decode(kiwi::ByteBuffer &_bb, kiwi::MemoryPool &_pool, const BinarySchema *_schema) {
  while (true) {
    uint32_t _type;
    if (!_bb.readVarUint(_type)) return false;
    switch (_type) {
      case 0:
        return true;
      case 1: {
        if (!_bb.readVarFloat(_data_frequency)) return false;
        set_frequency(_data_frequency);
        break;
      }
      case 2: {
        if (!_bb.readVarFloat(_data_wiggle)) return false;
        set_wiggle(_data_wiggle);
        break;
      }
      case 3: {
        if (!_bb.readVarFloat(_data_smoothen)) return false;
        set_smoothen(_data_smoothen);
        break;
      }
      default: {
        if (!_schema || !_schema->skipDynamicStrokeSettingsField(_bb, _type)) return false;
        break;
      }
    }
  }
...
DynamicStrokeSettings *PixsoNode::dynamicStrokeSettings() {
  return _data_dynamicStrokeSettings;
}

const DynamicStrokeSettings *PixsoNode::dynamicStrokeSettings() const {
  return _data_dynamicStrokeSettings;
}

void PixsoNode::set_dynamicStrokeSettings(DynamicStrokeSettings *value) {
  _data_dynamicStrokeSettings = value;
}

int32_t *PixsoNode::strokeSeed() {
  return _flags[7] & 4194304 ? &_data_strokeSeed : nullptr;
}

const int32_t *PixsoNode::strokeSeed() const {
  return _flags[7] & 4194304 ? &_data_strokeSeed : nullptr;
}

void PixsoNode::set_strokeSeed(const int32_t &value) {
  _flags[7] |= 4194304; _data_strokeSeed = value;
}
...
bool PixsoNode::encode(kiwi::ByteBuffer &_bb) {
  ...
  if (dynamicStrokeSettings() != nullptr) {
    _bb.writeVarUint(246);
    if (!_data_dynamicStrokeSettings->encode(_bb)) return false;
  }
  if (strokeSeed() != nullptr) {
    _bb.writeVarUint(247);
    _bb.writeVarInt(_data_strokeSeed);
  }
  _bb.writeVarUint(0);
  return true;
}
...
bool PixsoNode::decode(kiwi::ByteBuffer &_bb, kiwi::MemoryPool &_pool, const BinarySchema *_schema) {
  ...
  while (true) {
    ...
    switch (_type) {
      ...
      case 246: {
        _data_dynamicStrokeSettings = _pool.allocate<DynamicStrokeSettings>();
        if (!_data_dynamicStrokeSettings->decode(_bb, _pool, _schema)) return false;
        break;
      }
      case 247: {
        if (!_bb.readVarInt(_data_strokeSeed)) return false;
        set_strokeSeed(_data_strokeSeed);
        break;
      }
      default: {
...
Paint *ProdMode::inactiveFillPaint() {
  return _data_inactiveFillPaint;
}

const Paint *ProdMode::inactiveFillPaint() const {
  return _data_inactiveFillPaint;
}

void ProdMode::set_inactiveFillPaint(Paint *value) {
  _data_inactiveFillPaint = value;
}

ProdOneDimChart *ProdMode::oneDimChart() {
  return _data_oneDimChart;
}

const ProdOneDimChart *ProdMode::oneDimChart() const {
  return _data_oneDimChart;
}

void ProdMode::set_oneDimChart(ProdOneDimChart *value) {
  _data_oneDimChart = value;
}
...
bool ProdMode::encode(kiwi::ByteBuffer &_bb) {
  ...
  if (inactiveFillPaint() != nullptr) {
    _bb.writeVarUint(52);
    if (!_data_inactiveFillPaint->encode(_bb)) return false;
  }
  if (oneDimChart() != nullptr) {
    _bb.writeVarUint(53);
    if (!_data_oneDimChart->encode(_bb)) return false;
  }
  _bb.writeVarUint(0);
  return true;
}
...
bool ProdMode::decode(kiwi::ByteBuffer &_bb, kiwi::MemoryPool &_pool, const BinarySchema *_schema) {
  ...
  while (true) {
    ...
    switch (_type) {
      ...
      case 52: {
        _data_inactiveFillPaint = _pool.allocate<Paint>();
        if (!_data_inactiveFillPaint->decode(_bb, _pool, _schema)) return false;
        break;
      }
      case 53: {
        _data_oneDimChart = _pool.allocate<ProdOneDimChart>();
        if (!_data_oneDimChart->decode(_bb, _pool, _schema)) return false;
        break;
      }
      default: {
...
VariableDataMap *ProdTextStyle::variableConsumptionMap() {
  return _data_variableConsumptionMap;
}

const VariableDataMap *ProdTextStyle::variableConsumptionMap() const {
  return _data_variableConsumptionMap;
}

void ProdTextStyle::set_variableConsumptionMap(VariableDataMap *value) {
  _data_variableConsumptionMap = value;
}
...
int32_t *ProdTDCElementinfo::styleType() {
  return _flags[0] & 8 ? &_data_styleType : nullptr;
}

const int32_t *ProdTDCElementinfo::styleType() const {
  return _flags[0] & 8 ? &_data_styleType : nullptr;
}

void ProdTDCElementinfo::set_styleType(const int32_t &value) {
  _flags[0] |= 8; _data_styleType = value;
}
...
bool ProdTDCElementinfo::encode(kiwi::ByteBuffer &_bb) {
  ...
  if (styleType() != nullptr) {
    _bb.writeVarUint(4);
    _bb.writeVarInt(_data_styleType);
  }
  _bb.writeVarUint(0);
  return true;
}
...
bool ProdTDCElementinfo::decode(kiwi::ByteBuffer &_bb, kiwi::MemoryPool &_pool, const BinarySchema *_schema) {
  while (true) {
    ...
    switch (_type) {
      ...
      case 4: {
        if (!_bb.readVarInt(_data_styleType)) return false;
        set_styleType(_data_styleType);
        break;
      }
      default: {
...
kiwi::Array<float> *ProdExtraCombinationChartInfo::axisScale() {
  return _flags[0] & 1 ? &_data_axisScale : nullptr;
}

const kiwi::Array<float> *ProdExtraCombinationChartInfo::axisScale() const {
  return _flags[0] & 1 ? &_data_axisScale : nullptr;
}

kiwi::Array<float> &ProdExtraCombinationChartInfo::set_axisScale(kiwi::MemoryPool &pool, uint32_t count) {
  _flags[0] |= 1; return _data_axisScale = pool.array<float>(count);
}

int32_t *ProdExtraCombinationChartInfo::axisType() {
  return _flags[0] & 2 ? &_data_axisType : nullptr;
}

const int32_t *ProdExtraCombinationChartInfo::axisType() const {
  return _flags[0] & 2 ? &_data_axisType : nullptr;
}

void ProdExtraCombinationChartInfo::set_axisType(const int32_t &value) {
  _flags[0] |= 2; _data_axisType = value;
}

bool ProdExtraCombinationChartInfo::encode(kiwi::ByteBuffer &_bb) {
  ...
  if (axisType() != nullptr) {
    _bb.writeVarUint(2);
    _bb.writeVarInt(_data_axisType);
  }
  _bb.writeVarUint(0);
  return true;
}

bool ProdExtraCombinationChartInfo::decode(kiwi::ByteBuffer &_bb, kiwi::MemoryPool &_pool, const BinarySchema *_schema) {
  uint32_t _count;
  while (true) {
    uint32_t _type;
    if (!_bb.readVarUint(_type)) return false;
    switch (_type) {
      ...
      case 2: {
        if (!_bb.readVarInt(_data_axisType)) return false;
        set_axisType(_data_axisType);
        break;
      }
      default: {
        if (!_schema || !_schema->skipProdExtraCombinationChartInfoField(_bb, _type)) return false;
        break;
      }
    }
  }
...
kiwi::Array<Path> *ProdOneDimChart::chartAreaFillGeometry() {
  return _flags[0] & 1 ? &_data_chartAreaFillGeometry : nullptr;
}

const kiwi::Array<Path> *ProdOneDimChart::chartAreaFillGeometry() const {
  return _flags[0] & 1 ? &_data_chartAreaFillGeometry : nullptr;
}

kiwi::Array<Path> &ProdOneDimChart::set_chartAreaFillGeometry(kiwi::MemoryPool &pool, uint32_t count) {
  _flags[0] |= 1; return _data_chartAreaFillGeometry = pool.array<Path>(count);
}

kiwi::Array<ProdTDCElementinfo> *ProdOneDimChart::TDCElementInfo() {
  return _flags[0] & 2 ? &_data_TDCElementInfo : nullptr;
}

const kiwi::Array<ProdTDCElementinfo> *ProdOneDimChart::TDCElementInfo() const {
  return _flags[0] & 2 ? &_data_TDCElementInfo : nullptr;
}

kiwi::Array<ProdTDCElementinfo> &ProdOneDimChart::set_TDCElementInfo(kiwi::MemoryPool &pool, uint32_t count) {
  _flags[0] |= 2; return _data_TDCElementInfo = pool.array<ProdTDCElementinfo>(count);
}

kiwi::Array<float> *ProdOneDimChart::legendSymPos() {
  return _flags[0] & 4 ? &_data_legendSymPos : nullptr;
}

const kiwi::Array<float> *ProdOneDimChart::legendSymPos() const {
  return _flags[0] & 4 ? &_data_legendSymPos : nullptr;
}

kiwi::Array<float> &ProdOneDimChart::set_legendSymPos(kiwi::MemoryPool &pool, uint32_t count) {
  _flags[0] |= 4; return _data_legendSymPos = pool.array<float>(count);
}

int32_t *ProdOneDimChart::legendDir() {
  return _flags[0] & 8 ? &_data_legendDir : nullptr;
}

const int32_t *ProdOneDimChart::legendDir() const {
  return _flags[0] & 8 ? &_data_legendDir : nullptr;
}

void ProdOneDimChart::set_legendDir(const int32_t &value) {
  _flags[0] |= 8; _data_legendDir = value;
}

int32_t *ProdOneDimChart::chartMode() {
  return _flags[0] & 16 ? &_data_chartMode : nullptr;
}

const int32_t *ProdOneDimChart::chartMode() const {
  return _flags[0] & 16 ? &_data_chartMode : nullptr;
}

void ProdOneDimChart::set_chartMode(const int32_t &value) {
  _flags[0] |= 16; _data_chartMode = value;
}

float *ProdOneDimChart::innerRadiusRatio() {
  return _flags[0] & 32 ? &_data_innerRadiusRatio : nullptr;
}

const float *ProdOneDimChart::innerRadiusRatio() const {
  return _flags[0] & 32 ? &_data_innerRadiusRatio : nullptr;
}

void ProdOneDimChart::set_innerRadiusRatio(const float &value) {
  _flags[0] |= 32; _data_innerRadiusRatio = value;
}

float *ProdOneDimChart::cornerRadius() {
  return _flags[0] & 64 ? &_data_cornerRadius : nullptr;
}

const float *ProdOneDimChart::cornerRadius() const {
  return _flags[0] & 64 ? &_data_cornerRadius : nullptr;
}

void ProdOneDimChart::set_cornerRadius(const float &value) {
  _flags[0] |= 64; _data_cornerRadius = value;
}

bool *ProdOneDimChart::titleSwitch() {
  return _flags[0] & 128 ? &_data_titleSwitch : nullptr;
}

const bool *ProdOneDimChart::titleSwitch() const {
  return _flags[0] & 128 ? &_data_titleSwitch : nullptr;
}

void ProdOneDimChart::set_titleSwitch(const bool &value) {
  _flags[0] |= 128; _data_titleSwitch = value;
}

bool *ProdOneDimChart::legendSwitch() {
  return _flags[0] & 256 ? &_data_legendSwitch : nullptr;
}

const bool *ProdOneDimChart::legendSwitch() const {
  return _flags[0] & 256 ? &_data_legendSwitch : nullptr;
}

void ProdOneDimChart::set_legendSwitch(const bool &value) {
  _flags[0] |= 256; _data_legendSwitch = value;
}

bool *ProdOneDimChart::dataLableSwitch() {
  return _flags[0] & 512 ? &_data_dataLableSwitch : nullptr;
}

const bool *ProdOneDimChart::dataLableSwitch() const {
  return _flags[0] & 512 ? &_data_dataLableSwitch : nullptr;
}

void ProdOneDimChart::set_dataLableSwitch(const bool &value) {
  _flags[0] |= 512; _data_dataLableSwitch = value;
}

bool *ProdOneDimChart::dataWinSwitch() {
  return _flags[0] & 1024 ? &_data_dataWinSwitch : nullptr;
}

const bool *ProdOneDimChart::dataWinSwitch() const {
  return _flags[0] & 1024 ? &_data_dataWinSwitch : nullptr;
}

void ProdOneDimChart::set_dataWinSwitch(const bool &value) {
  _flags[0] |= 1024; _data_dataWinSwitch = value;
}

bool ProdOneDimChart::encode(kiwi::ByteBuffer &_bb) {
  if (chartAreaFillGeometry() != nullptr) {
    _bb.writeVarUint(1);
    _bb.writeVarUint(_data_chartAreaFillGeometry.size());
    for (Path &_it : _data_chartAreaFillGeometry) if (!_it.encode(_bb)) return false;
  }
  ...
  if (innerRadiusRatio() != nullptr) {
    _bb.writeVarUint(6);
    _bb.writeVarFloat(_data_innerRadiusRatio);
  }
  if (cornerRadius() != nullptr) {
    _bb.writeVarUint(7);
    _bb.writeVarFloat(_data_cornerRadius);
...
bool ProdOneDimChart::decode(kiwi::ByteBuffer &_bb, kiwi::MemoryPool &_pool, const BinarySchema *_schema) {
  uint32_t _count;
  while (true) {
    uint32_t _type;
    if (!_bb.readVarUint(_type)) return false;
    switch (_type) {
      ...
      case 1: {
        if (!_bb.readVarUint(_count)) return false;
        for (Path &_it : set_chartAreaFillGeometry(_pool, _count)) if (!_it.decode(_bb, _pool, _schema)) return false;
        break;
      }
      case 2: {
        if (!_bb.readVarUint(_count)) return false;
      ...
      case 6: {
        if (!_bb.readVarFloat(_data_innerRadiusRatio)) return false;
        set_innerRadiusRatio(_data_innerRadiusRatio);
        break;
      }
      case 7: {
        if (!_bb.readVarFloat(_data_cornerRadius)) return false;
      ...
      default: {
        if (!_schema || !_schema->skipProdOneDimChartField(_bb, _type)) return false;
        break;
      }
    }
  }
...
ProdExtraCombinationChartInfo *ProdTwoDimChart::extraCombinationChartInfo() {
  return _data_extraCombinationChartInfo;
}

const ProdExtraCombinationChartInfo *ProdTwoDimChart::extraCombinationChartInfo() const {
  return _data_extraCombinationChartInfo;
}

void ProdTwoDimChart::set_extraCombinationChartInfo(ProdExtraCombinationChartInfo *value) {
  _data_extraCombinationChartInfo = value;
}
...
bool ProdTwoDimChart::encode(kiwi::ByteBuffer &_bb) {
  ...
  if (extraCombinationChartInfo() != nullptr) {
    _bb.writeVarUint(15);
    if (!_data_extraCombinationChartInfo->encode(_bb)) return false;
  }
  _bb.writeVarUint(0);
  return true;
}
...
bool ProdTwoDimChart::decode(kiwi::ByteBuffer &_bb, kiwi::MemoryPool &_pool, const BinarySchema *_schema) {
  ...
  while (true) {
    ...
    switch (_type) {
      ...
      case 15: {
        _data_extraCombinationChartInfo = _pool.allocate<ProdExtraCombinationChartInfo>();
        if (!_data_extraCombinationChartInfo->decode(_bb, _pool, _schema)) return false;
        break;
      }
      default: {
...
bool *TextStyleData::isOverrideOverTextStyle() {
  return _flags[0] & 33554432 ? &_data_isOverrideOverTextStyle : nullptr;
}

const bool *TextStyleData::isOverrideOverTextStyle() const {
  return _flags[0] & 33554432 ? &_data_isOverrideOverTextStyle : nullptr;
}

void TextStyleData::set_isOverrideOverTextStyle(const bool &value) {
  _flags[0] |= 33554432; _data_isOverrideOverTextStyle = value;
}
...
bool TextStyleData::encode(kiwi::ByteBuffer &_bb) {
  ...
  if (isOverrideOverTextStyle() != nullptr) {
    _bb.writeVarUint(26);
    _bb.writeByte(_data_isOverrideOverTextStyle);
  }
  _bb.writeVarUint(0);
  return true;
}
...
bool TextStyleData::decode(kiwi::ByteBuffer &_bb, kiwi::MemoryPool &_pool, const BinarySchema *_schema) {
  ...
  while (true) {
    ...
    switch (_type) {
      ...
      case 26: {
        if (!_bb.readByte(_data_isOverrideOverTextStyle)) return false;
        set_isOverrideOverTextStyle(_data_isOverrideOverTextStyle);
        break;
      }
      default: {
